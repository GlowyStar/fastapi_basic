"""Add bookings, users, rooms, reformat hotels tables

Revision ID: d73c996d25cc
Revises: aac9d8e39e94
Create Date: 2025-01-25 21:31:27.862523
...
revision: str = 'd73c996d25cc'
down_revision: Union[str, None] = 'aac9d8e39e94'
...
def upgrade() -> None:
    ...
    op.create_index('ix_rooms_price', 'rooms', ['price'], unique=False)
    ...
    op.create_index('ix_hotels_location', 'hotels', ['location'], unique=False)
